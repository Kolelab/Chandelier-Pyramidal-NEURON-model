...
default_syn_weight = 0.004  # Default synaptic weight
...
class Synapse:
    def __init__(self, presynaptic_cell, postsynaptic_cell, pre_section, post_fraction):
        ...
        self.post_section = postsynaptic_cell.soma  # Pyramidal soma
...
def connect_boutons(chc, pyr):
    ...
    for bouton, fraction in bouton_data:
        print(f"Connecting bouton {bouton.name()} to soma at {fraction * pyr.axon[0].L} µm")
